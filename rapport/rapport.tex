...
Selon la valeur de $b$, les bits non nuls de $P(B)$ peuvent correspondre à une ou deux Sboxes. C'est ce qu'on entend par les cas "une active box" et "deux active boxes".
