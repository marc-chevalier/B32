...
public:
    ...
    ~Attack() {};
    unsigned int make_guess(std::pair<unsigned int, unsigned int> couple, unsigned int position, bool verbose);
    std::bitset<BLOC_LENGTH> find_K2(std::pair<unsigned int, unsigned int> couple, bool verbose);
